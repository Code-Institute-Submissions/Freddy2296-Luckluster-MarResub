...
[Balsamiq Cloud](https://balsamiq.cloud/). This is the web version of Balsamiq Wireframes tool, which is used to design user interfaces online. 
...
application itself. This facilitated the early deployment of the User Registration and Authentication system through the django platform. Within the [deployed site]() 
...
can happen should the user attempt browser url injection to get to gain access to areas of the site e.g. if a user is logged in and attempts to access ``,
...
Management area (``). This area is exclusive to superusers, and inappropriate for normal user accounts. Therefore, when a normal user
...
Special thanks to my mentor, Aaron. For his guidance throughout this project, I would also like to give credits to Damien-Meere 
